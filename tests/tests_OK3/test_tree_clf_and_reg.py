...
################# Test Restults in and Error on New versions of scikit-learn #########
#  test_min_impurity_split
#  test_X_idx_sorted_deprecated
########    Need to modify to make it execute on new versions of Python ################
...
import stpredictions.models.OK3._tree
...
from stpredictions.models.OK3._tree import TREE_LEAF, TREE_UNDEFINED
from stpredictions.models.OK3._classes import CRITERIA
...
def test_min_samples_split():
    ...
    X = np.asfortranarray(iris.data, dtype=stpredictions.models.OK3._tree.DTYPE)
    y = iris.target
...
def test_sample_weight():
    ...
    internal = clf.tree_.children_left != stpredictions.models.OK3._tree.TREE_LEAF
...
def check_public_apply(name):
    X_small32 = X_small.astype(stpredictions.models.OK3._tree.DTYPE, copy=False)
...
def check_public_apply_sparse(name):
    X_small32 = csr_matrix(X_small.astype(stpredictions.models.OK3._tree.DTYPE, copy=False))
...
def check_apply_path_readonly(name):
    X_readonly = create_memmap_backed_data(X_small.astype(stpredictions.models.OK3._tree.DTYPE,
                                                          copy=False))
    y_readonly = create_memmap_backed_data(np.array(y_small,
                                                    dtype=stpredictions.models.OK3._tree.DTYPE))
    for kernel in ["gini_clf", "mse_reg"]:
        est = OKTREES[name](kernel=kernel)
